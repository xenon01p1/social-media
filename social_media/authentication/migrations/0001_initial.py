    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verify_status', models.CharField(blank=True, max_length=1, null=True)),
                ...
                ('delete_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='deleted_users', to='authentication.customuser')),
                ...
                ('insert_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='inserted_users', to='authentication.customuser')),
                ('update_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='updated_users', to='authentication.customuser')),
